...
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (1, 'ADMIN', 1, 1);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (2, 'MANAGER', 2, 1);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (3, 'MEMBER', 3, 1);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (4, 'ADMIN', 2, 2);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (5, 'ADMIN', 2, 3);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (6, 'MANAGER', 2, 4);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (7, 'ADMIN', 3, 4);
INSERT INTO `memberships` (`id`, `role`, `team_id`, `person_id`) VALUES (8, 'ADMIN', 3, 5);
