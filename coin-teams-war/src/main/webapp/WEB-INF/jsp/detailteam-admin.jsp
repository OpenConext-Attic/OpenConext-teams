...
<div class="section" id="TeamContainer">
	...
	<div id="Header">
		...
		<ul class="team-options">
			<li><a href="editteam.shtml?team=1"><spring:message code='jsp.detailteam.Edit' /></a></li>
			<li><a href="deleteteam.shtml?team=1"><spring:message code='jsp.detailteam.Delete' /></a></li>
	...
	<div id="Content">
		...
		<span class="add-member"><a href="addmember.shtml?team=1"></a><spring:message code='jsp.addmember.Title' /></span>
		<table>
