...
public interface TeamService extends GrouperDao {
   ...
   * 
   * @param teamId
   *          the id of a {@link Team}
   * @param displayName
   *          the new displayName
   * @param teamDescription
   *          the new description of the {@link Team}
   */
   ...
   * 
   * @param teamId
   *          the unique identifier of a {@link Team}
   * @param memberId
   *          the unique identifier of a {@link Member}
   * @param role
   *          the {@link Role} to be added
   * @param addAsSuperUser
   *          boolean whether to assign the privileges as the super user
   ...
   *          the unique identifier of a {@link Member}
   * @param role
   *          the {@link Role} to be removed
   * @param removeAsSuperUser
   *          as the grouper superuser?
   * @return boolean true if the {@link Role} has been successfully added false
   *         if the {@link Role} has not been added
   */
  boolean removeMemberRole(String teamId, String memberId, Role role,
      boolean removeAsSuperUser);
