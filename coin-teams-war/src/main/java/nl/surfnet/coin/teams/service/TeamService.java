...
public interface TeamService extends GrouperDao {
   ...
   * @param memberId       the unique identifier of a {@link Member}
   ...
   *
   * @param teamId   the unique identifier of the {@link nl.surfnet.coin.teams.domain.Team}
   * @param person  {@link Person} to add as Member to the Team
   */
   ...
   *
   * @param teamId   the unique identifier of the {@link Team}
   * @param memberId the unique identifier of a {@link Member}
   * @return {@link Member} or {@literal null} if the Team does
   *         not contain a Member by the memberId
   */
